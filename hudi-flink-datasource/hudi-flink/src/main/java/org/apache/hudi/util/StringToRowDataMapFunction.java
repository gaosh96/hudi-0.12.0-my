 ...
 * @since 10/19/22
 */
public class StringToRowDataMapFunction extends RichMapFunction<String, RowData> {

    private static final Logger LOG = LoggerFactory.getLogger(StringToRowDataMapFunction.class);
    ...
    public StringToRowDataMapFunction(String schemaApolloConfigKey) {
    ...
    private void handleFieldInfo(String schema) {
